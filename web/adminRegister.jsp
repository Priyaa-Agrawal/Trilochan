<%-- 
    ...
    Created on : Aug 5, 2019, 12:16:20 PM
    Author     : dell
--%>
...
<div class="login-form">
    <form action="registerServlet" method="post">
        ...
        <div class="form-group">
            ...
            <button type="submit" class="btn btn-primary btn-block"><a href="userlogin.jsp" style="color:black">Log In</button>
        </div>
       </form>
