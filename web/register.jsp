<%-- 
    Document   : register
    Created on : Aug 5, 2019, 12:28:42 PM
    Author     : dell
--%>
...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <meta charset="UTF-8">
    <!-- Site Title -->
    <title>UserRegister-Trilochan</title>
<!--          CSS
            ============================================= -->
    ...
    <form action="registerServlet" method="post">
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" name="email" placeholder="Email" required="required">
                ...
                <div class="form-group">
            <input type="text" class="form-control" name="phno" placeholder="Phone" required="required">
        </div>
                <div class="form-group">
        ...
        <div class="form-group">
            ...
            <button type="submit" class="btn btn-primary btn-block" onclick="location.href='userlogin.jsp'">Log In</button>
        </div>
       </form>
