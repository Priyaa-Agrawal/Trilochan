<%-- 
    ...
    Created on : Aug 5, 2019, 12:29:21 PM
    Author     : dell
--%>
...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <meta charset="UTF-8">
    <!-- Site Title -->
    <title>SetPassword-Trilochan</title>
<!--          CSS
            ============================================= -->
...
<div class="login-form">
    <form method="post" action="password" >
        <h2 style="color:goldenrod"> Set New Password</h2>
        <div class="form-group">
            <input type="password" class="form-control" name="pass" placeholder="New Password" required="required">
        </div>
        <div class="form-group">
            <input type="hidden" class="form-control" name="otp" value=<%=otp%>>
        </div>
        <div class="form-group">
